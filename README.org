...
- /An abbreviation that ends a sentence./  After =etc.= the typing holds back,
  ...
  are left as two.  Some defaults do this more often than others: =U.S.=,
  =a.m.= and =Ave.= end sentences about as readily as they sit inside one,
  and =garamond-removed-abbreviations= is how you drop the ones that get in
  your way.
